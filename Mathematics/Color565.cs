...
namespace Shiftless.Common.Mathematics
{
    ...
    {
        // Constants
        private const ushort R_CLEAR_MASK = 0b0000011111111111;
        private const ushort G_CLEAR_MASK = 0b1111100000011111;
        private const ushort B_CLEAR_MASK = 0b1111111111100000;
        ...
        public byte B
        {
            readonly get => MHelp.Map((byte)((PackedValue >> 5) & 31), 31, 255);
            set
            {
                byte mappedValue = MHelp.Map(value, 255, 31);
        ...
        public Color565(uint packedColor) : this((byte)((packedColor >> 24) & 255), (byte)((packedColor >> 16) & 255), (byte)((packedColor >> 8) & 255)) { }
